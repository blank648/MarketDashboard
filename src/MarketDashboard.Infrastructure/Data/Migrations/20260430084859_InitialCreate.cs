...
namespace MarketDashboard.Infrastructure.Data.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MarketPrices_Symbols_SymbolId",
                        column: x => x.SymbolId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OhlcvRecords", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OhlcvRecords_Symbols_SymbolId",
                        column: x => x.SymbolId,
                        principalTable: "Symbols",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Symbol = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    ThresholdPrice = table.Column<decimal>(type: "numeric(18,6)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PriceAlerts_Symbols_SymbolId",
                        column: x => x.SymbolId,
                        principalTable: "Symbols",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceAtTrigger = table.Column<decimal>(type: "numeric(18,6)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AlertHistory_PriceAlerts_AlertId",
                        column: x => x.AlertId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MarketPrices_Symbol_RecordedAt",
                table: "MarketPrices",
                columns: new[] { "Symbol", "RecordedAt" },
                descending: new[] { false, true });

            migrationBuilder.CreateIndex(
                name: "IX_MarketPrices_SymbolId",
                table: "MarketPrices",
                column: "SymbolId");

            migrationBuilder.CreateIndex(
                name: "IX_OhlcvRecords_Symbol_PeriodStart",
                table: "OhlcvRecords",
                columns: new[] { "Symbol", "PeriodStart" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_OhlcvRecords_SymbolId",
                table: "OhlcvRecords",
                column: "SymbolId");

            migrationBuilder.CreateIndex(
                name: "IX_PriceAlerts_SymbolId",
                table: "PriceAlerts",
                column: "SymbolId");
